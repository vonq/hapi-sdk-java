...
import com.vonq.api.marketplacesandbox.http.request.configuration.RetryConfiguration;
...
public class RetryInterceptor implements Interceptor {
    ...
    */
    ...
    public void addRequestEntry(Request okHttpRequest, RetryConfiguration retryConfiguration,
            HttpRequest httpRequest, boolean binaryResponse) {
        this.requestEntries.put(okHttpRequest, new RequestState(retryConfiguration, httpRequest,
                binaryResponse));
    }
    ...
    private class RequestState {
         ...
         * @param binaryResponse flag for expected response of request.
         */
        private RequestState(RetryConfiguration retryConfiguration, HttpRequest httpRequest,
                boolean binaryResponse) {
