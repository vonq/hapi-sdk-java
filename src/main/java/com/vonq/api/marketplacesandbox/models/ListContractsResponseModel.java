...
/**
 * This is a model class for ListContractsResponseModel type.
 */
public class ListContractsResponseModel
        extends BaseModel {
    ...
    /**
     * Converts this ListContractsResponseModel into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ListContractsResponseModel [" + "count=" + count + ", previous=" + previous
                + ", next=" + next + ", results=" + results + ", additionalProperties="
                + getAdditionalProperties() + "]";
    }

    /**
     * Builds a new {@link ListContractsResponseModel.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ListContractsResponseModel.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ListContractsResponseModel}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ListContractsResponseModel} object using the set fields.
         * @return {@link ListContractsResponseModel}
         */
        public ListContractsResponseModel build() {
            return new ListContractsResponseModel(count, previous, next, results);
        }
    }
}
